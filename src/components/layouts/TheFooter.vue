          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li
                    v-for="(item, key) in sponsor.list"
                    :key="key"
                >
                  <a
                    :href="item.link"
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li
                    v-for="(item, key) in statistics.list"
                    :key="key"
                    >
    ...
    data() {
        ...
        designer: `
                <span style="font-size:0.9em">Designed by
                    ...
                    <a href="https://github.com/Oyxiaoxi"target="_blank"style="color:inherit">Oyxiaoxi</a>
                </span>
        `,
        sponsor: {
            title: '赞助商',
