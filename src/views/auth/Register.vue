...
<style scoped>
.thumbnail { width: 120px; margin-top: 10px; cursor: pointer;}
.thumbnail .captcha { height: 40px; background: #E1E6E8;}
.captcha { font-size: 18px; font-weight: bold; user-select: none;}
</style>
